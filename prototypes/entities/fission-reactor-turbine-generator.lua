...
{
	{
		...
		icon = "__UraniumPower__/graphics/icons/turbine-generator-lu.png",
		...
		vertical_animation =
		{
			filename = "__UraniumPower__/graphics/entities/turbine-generator/turbineh.png",
			width = 1000,
			height = 1000,
			frame_count = 4,
			line_length = 2,
		...
		{
			filename = "__UraniumPower__/graphics/entities/turbine-generator/turbinev2.png",
			width = 1000,
			height = 1000,
			frame_count = 4,
			line_length = 2,
	...
	},
	{
		...
		icon = "__UraniumPower__/graphics/icons/turbine-generator-rd.png",
		flags = {"placeable-neutral", "placeable-player", "player-creation", "not-blueprintable", "not-deconstructable"},
		...
		vertical_animation =
		{
			filename = "__UraniumPower__/graphics/entities/turbine-generator/turbineh2.png",
			width = 1000,
			height = 1000,
			frame_count = 4,
			line_length = 2,
		...
		horizontal_animation =
		{
			filename = "__UraniumPower__/graphics/entities/turbine-generator/turbinev.png",
			width = 1000,
			height = 1000,
			frame_count = 4,
			line_length = 2,
