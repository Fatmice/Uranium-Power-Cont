data:extend({
	...
	},
	{
		...
		animation =
		{
			filename = "__UraniumPower__/graphics/entities/null/null.png",
			flags = {"compressed" },
			priority = "low",
			width = 224,
			height = 108,
	...
	--[[{
		...
		{
			{
				filename = "__UraniumPower__/graphics/entities/explosions/uranium-explosion-1.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				frame_count = 60,
	...
	
	{
		...
		{
			{
				filename = "__UraniumPower__/graphics/entities/explosions/LUQ.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				frame_count = 64,
	...
	},
	{
		...
		{
			{
				filename = "__UraniumPower__/graphics/entities/explosions/RUQ.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				frame_count = 64,
	...
	},
	{
		...
		{
			{
				filename = "__UraniumPower__/graphics/entities/explosions/LLQ.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				frame_count = 64,
	...
	},
	{
		...
		{
			{
				filename = "__UraniumPower__/graphics/entities/explosions/RLQ.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				frame_count = 64,
