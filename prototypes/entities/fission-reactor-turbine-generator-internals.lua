...
{	
	{
		...
		icon = "__UraniumPower__/graphics/icons/feed-water-reservoir.png",
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/turbineinternalfeedwaterHV.png",
					priority = "extra-high",
					frames = 2,
					width = 540,
					height = 540,
	...
	},
	{
		...
		icon = "__UraniumPower__/graphics/icons/condenser.png",
		flags = {"placeable-neutral", "placeable-player", "not-blueprintable", "not-deconstructable"},
		minable = {hardness = 0.2, mining_time = 0.05},
		max_health = 50,
		corpse = "small-remnants",
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/coldlegtank.png",
					priority = "extra-high",
					frames = 2,
					width = 540,
					height = 540,
	...
	},
	{
		...
		icon = "__UraniumPower__/graphics/icons/low-pressure-steam-reservoir.png",
		flags = {"placeable-neutral", "placeable-player", "not-blueprintable", "not-deconstructable"},
		minable = {hardness = 0.2, mining_time = 0.05},
		max_health = 50,
		corpse = "small-remnants",
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/steamreservea0.png",
					priority = "extra-high",
					frames = 1,
					width = 1000,
					height = 1000,
	...
	},
	{
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/steamreservea2.png",
					priority = "extra-high",
					frames = 1,
					width = 1000,
					height = 1000,
	...
	},
	{
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/steamreserveb0.png",
					priority = "extra-high",
					frames = 1,
					width = 1000,
					height = 1000,
	...
	},
	{
		...
		pictures =
		{
			picture =
			{
				sheet =
				{
					filename = "__UraniumPower__/graphics/entities/turbine-generator-internals/steamreserveb2.png",
					priority = "extra-high",
					frames = 1,
					width = 1000,
					height = 1000,
