...
{
	{
		...
		icon = "__UraniumPower__/graphics/icons/cold-leg.png",
		...
		pictures =
		{
			picture =
			{
				north =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals-bigger/steamgeninternalcold03.png",
					priority = "extra-high",
					frames = 1,
					width = 2048,
					height = 2048,
				...
				east =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals-bigger/steamgeninternalcold04.png",
					priority = "extra-high",
					frames = 1,
					width = 2048,
					height = 2048,
				...
				south =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals-bigger/steamgeninternalcold01.png",
					priority = "extra-high",
					frames = 1,
					width = 2048,
					height = 2048,
				...
				west =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals-bigger/steamgeninternalcold02.png",
					priority = "extra-high",
					frames = 1,
					width = 2048,
					height = 2048,
	...
	--for steam gen direction 2	
	{
		...
		pictures =
		{
			picture =
			{
				north =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals/STEAMGENINTERNAL02.png",
					priority = "extra-high",
					frames = 1,
					width = 540,
					height = 540,
				...
				east =
				{
					filename = "__UraniumPower__/graphics/entities/steam-generator-internals/STEAMGENINTERNAL01.png",
					priority = "extra-high",
					frames = 1,
					width = 540,
					height = 540,
	...
	{
		type = "storage-tank",
		name = "reactor-pipe-bus-vert-bigger", --nee vertical pipe bus 01
		icon = "__UraniumPower__/graphics/icons/hot-leg.png",
		flags = {"placeable-neutral", "placeable-player", "not-blueprintable", "not-deconstructable"},
		minable = {hardness = 0.1, mining_time = 0.1},
		max_health = 100,
		corpse = "small-remnants",
		collision_box = {{-0.5, -4.0}, {0.5, 4.0}},
		selection_box = {{-0.5, -4.0}, {0.5, 4.0}},
		drawing_box = {{-0.5, -4.0}, {0.5, -3.5}},
		fluid_box =
		{
			base_area = 150,
			base_level = -1,
