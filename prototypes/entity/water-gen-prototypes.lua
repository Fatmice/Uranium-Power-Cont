...
{
	{
		...
		pictures =
		{
			picture =
			{
				north =
				{
					filename = "__UraniumPower__/graphics/entity/water-gen/water-gen-passive-standin.png",
					width = 128,
					height = 128,
					frame_count = 1,
					--scale = 160/613,
	...
	},
	{
		...
		pictures =
		{
			picture =
			{
				north =
				{
					filename = "__UraniumPower__/graphics/entity/water-gen/water-gen-active-standin.png",
					width = 128,
					height = 128,
					frame_count = 1,
					--scale = 160/613,
