data:extend({
	...
	},
  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "test-pipe-A"},
    max_health = 50,
    corpse = "small-remnants",
    resistances =
    {
	...
	},
  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "test-pipe-B"},
    max_health = 50,
    corpse = "small-remnants",
    resistances =
    {
	...
	},
  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "test-pipe-C"},
    max_health = 50,
    corpse = "small-remnants",
    resistances =
    {
