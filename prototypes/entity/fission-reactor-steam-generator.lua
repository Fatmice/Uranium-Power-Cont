...
{
	{
		...
		pictures =
		{
			picture =
			{
				north =
				{
					filename = "__UraniumPower__/graphics/entity/steam-generator-bigger/hidefsteamgen04.png",
					width = 2048,
					height = 2048,
					frame_count = 1,
					scale = 160/1278,
				...
				east =
				{
					filename = "__UraniumPower__/graphics/entity/steam-generator-bigger/hidefsteamgen01.png",
					width = 2048,
					height = 2048,
					frame_count = 1,
					scale = 160/1278,
				...
				south =
				{
					filename = "__UraniumPower__/graphics/entity/steam-generator-bigger/hidefsteamgen02.png",
					width = 2048,
					height = 2048,
					frame_count = 1,
					scale = 160/1278,
				...
				west =
				{
					filename = "__UraniumPower__/graphics/entity/steam-generator-bigger/hidefsteamgen03.png",
					width = 2048,
					height = 2048,
					frame_count = 1,
					scale = 160/1278,
