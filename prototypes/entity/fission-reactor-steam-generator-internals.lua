data:extend(
{
    ...
    pictures =
    {
		picture =
		{
			north =
			{
				filename = "__UraniumPower__/graphics/entity/steam-generator-internals-bigger/steamgeninternalcold03.png",
				priority = "extra-high",
				frames = 1,
				width = 2048,
				height = 2048,
			...
			east =
			{
				filename = "__UraniumPower__/graphics/entity/steam-generator-internals-bigger/steamgeninternalcold04.png",
				priority = "extra-high",
				frames = 1,
				width = 2048,
				height = 2048,
			...
			south =
			{
				filename = "__UraniumPower__/graphics/entity/steam-generator-internals-bigger/steamgeninternalcold01.png",
				priority = "extra-high",
				frames = 1,
				width = 2048,
				height = 2048,
			...
			west =
			{
				filename = "__UraniumPower__/graphics/entity/steam-generator-internals-bigger/steamgeninternalcold02.png",
				priority = "extra-high",
				frames = 1,
				width = 2048,
				height = 2048,
